...
class BinarySphericalQuantizer(nn.Module):
    def __init__(self, embed_dim, beta, gamma0, gamma, zeta,
        ...
        self.group_codebook: torch.Tensor
    ...
    def soft_entropy_loss(self, z):
        ...
        group_code_book = self.group_codebook / (self.embed_dim ** 0.5 if self.l2_norm else 1.0)
...
class RotaryPositionalEmbedding(nn.Module):
    ...
    def _update_cos_sin_cache(self, x: torch.Tensor, seq_len: int) -> tuple[torch.Tensor, torch.Tensor]:
